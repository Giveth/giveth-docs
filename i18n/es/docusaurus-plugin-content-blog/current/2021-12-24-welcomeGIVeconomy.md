...
To read more about the GIVdrop and eligibility, [check out our documentation](/es/giveconomy/givdrop) or [see if you qualify](https://giveth.io/claim).
...
[**Welcome to the GIVeconomy**](https://giveth.io/giveconomy)
-------------------------------------------------------
