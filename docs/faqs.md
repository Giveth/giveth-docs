...
title: "FAQs"
sidebar_label: "💭 FAQs"
notion_page_id: "1703ab28-d48c-8122-9bb6-d0abde75dbd7"
slug: "/faq"
---
...
Projects that are found to exhibit “unacceptable behaviour” and/or violate our [Covenant](/covenant) and/or [Terms of Use](https://giveth.io/tos) are considered prohibited and will be cancelled immediately and an email will be send to the project owner. Learn more in our [documentation article](/listedunlisted).
...
Giveth’s mission is to reward & empower those who give – to projects, to society & to the world. The GIV token fuels and drives the GIVeconomy and some has been already distributed to those who have contributed to making Giveth what it is today. Anyone with an Ethereum wallet can get GIV via our [GIVbacks program](/givbacks) by donating to verified projects. GIV is a governance token that allows our community to actively participate in shaping the future of Giveth in a decentralized way.

**What network is the GIV token on?**
GIV was deployed on Ethereum Mainnet and is used most heavily on Gnosis Chain (xDai). However, the GIViverse is multi-chained and GIV will likely be bridged/transferred to other chains and Layer 2 networks. Check out the [GIV token linktree](https://linktr.ee/givtoken) to find all of the best places to get and bridge GIV.
...
\* By [donating](https://giveth.io/projects) to verified projects and getting [GIVbacks](/givbacks).
