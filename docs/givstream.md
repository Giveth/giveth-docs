...
id: "givstream"
title: "GIVstream"
sidebar_label: "🔀 GIVstream"
notion_page_id: "1703ab28-d48c-81b3-b68b-eb887ee1e874"
slug: "/givstream"
---
...
At launch, 10% of the total token supply of 1 billion GIV will be liquid and distributed across the [GIVeconomy](/giveconomy). The rest supplies the GIVstream which flows for 5 years, releasing more liquid GIV every second. After the 5 year period, 100% of GIV tokens will be liquid.
...
[Video](https://drive.google.com/file/d/1paY-RRMq0pXtMuJIUEhJaviUFOldAb0D/view?usp=drive_link)

Your GIVstream flowrate is the rate (GIV/week) at which your GIV becomes liquid. All recipients of the [GIVdrop](/givdrop) received a GIVstream on Gnosis Chain. If you did not receive a GIVdrop, you can also get a GIVstream by participating in the GIVeconomy.

You can get (or increase) your GIVstream flowrate on Gnosis Chain, Optimism Network or Polygon zkEVM by donating and winning [GIVbacks](https://giveth.io/givbacks) rewards from the raffle, by staking in the [GIVfarm](https://giveth.io/givfarm), or by adding value to the Giveth community and getting rewards via vesting or [Praise](https://praise.giveth.io/).
...
![](/img/notion/givstream/givstream-01.png)
