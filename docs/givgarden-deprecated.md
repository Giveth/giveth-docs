...
_**The GIVgarden was deprecated as of March 7th 2024. Find the most current info for **_[_**Giveth Governance in our related documentation**_](/governanceprocess)_**.**_
...
The GIVgarden uses the [Giveth Community Covenant](/covenant) as a decentralized social contract that outlines standards for on-chain and off-chain behaviour.
...
3. **Use Advice Process.** Following your forum post the community will give you feedback and express any concerns. [The Advice Process](/adviceprocess) will allow you to modify your proposal or address any concerns ensuring it is the best version possible and achieves maximum consensus.

4. \*Sign the Giveth Covenant. Signing that you agree to the [Giveth Covenant](/covenant) in the GIVgardens will permit you to begin using the governance tools it provides.
