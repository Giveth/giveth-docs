---
id: "givfarm-deprecated"
title: "GIVfarm (deprecated)"
sidebar_label: "🌾 GIVfarm (deprecated)"
notion_page_id: "1703ab28-d48c-81ae-9d8a-ec2b1c82d19c"
slug: "/givfarm"
---

:::note 💡
GIV Liquidity Mining has ended
All GIV LP staking pools have been retired, with the exception of [100% GIV Staking](https://qf.giveth.io/account?tab=staking) (GIVpower) on select chains. If you had LP tokens staked or rewards earned from old staking pools, you can still unstake or claim directly from the contracts by following the instructions in our documentation here.

:::

:::note 🚨
This documentation exists only as a historical reference and much of its contents are out of date.
:::
...
:::info ℹ️
**NOTE**
10 Million GIV was [originally allocated](/giveconomy) as rewards for a GIV/ETH Uniswap V3 pool on Mainnet. However, we detected one actor that was abusing a vulnerability in the system to earn rewards disproportionately and then dump the GIV. The community voted to terminate the Univ3 rewards program ([snapshot](https://snapshot.org/#/giv.eth/proposal/0xfad6aa3baa36d5f2d7acdf135752aafca06201b77a80aee79baf6ff3f5bbaae5)), and they were shut off on March 21st, 2022. You can learn more about it [here](https://twitter.com/Givethio/status/1505981603293585410).
...
:::note 🗒️
In October 2022, the GIVfarm was exploited on ETH Mainnet and the hacker was able to steal unclaimed GIV and CULT rewards. Users affected by these exploits have had all of their earnings reimbursed by having them added to their GIVstream of CULTstream and the community voted not to restart the affected GIV pools. You can real more about it [here.](https://x.com/Giveth/status/1591431388271677440) 
:::
