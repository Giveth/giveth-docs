...
We often use polls inside the forum or on Discord to get soft-consensus for preferred outcomes. It’s acceptable to use these same methods for [informal or low-impact decisions](/governanceprocess). However, for formal proposals they must indicate a clear intended outcome to keep objectives as clear as possible. The on-chain voting systems we use do not support multiple-choice voting.\*
...
Not all decisions require formal on-chain votes. There is room for making low-impact, agile decisions via a range of platforms that Giveth’s community utilizes. For the most clarity we refer to the Covenant’s section on [off-chain decision making](/covenant):
