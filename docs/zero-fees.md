...
Giveth is constantly integrating [more networks](/projectdonating) with lower [gas fees](https://bitpay.com/blog/eth-gas-fees/) (the amount you pay to the blockchain network when transacting crypto) and additional token options for donors to choose from. For some networks we work with, these fees are fractions of a penny!
