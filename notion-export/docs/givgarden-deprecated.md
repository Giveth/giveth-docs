---
id: "givgarden-deprecated"
title: "GIVgarden (deprecated)"
sidebar_label: "🌱 GIVgarden (deprecated)"
notion_page_id: "1703ab28-d48c-80bf-ae57-d457dc78585b"
---

_**The GIVgarden was deprecated as of March 7th 2024. Find the most current info for **_[_**Giveth Governance in our related documentation**_](/governance-process)_**.**_

_**This documentation will remain available for historical reference.**_

---

Giveth has chosen the Gardens DAO governance platform developed by [1hive](_https://forum.1hive.org/t/welcome-to-1hive/7) to allow GIV token holders to manage the DAO configurations and allocate funds to projects that are aligned with its [mission, vision and values](/934200f174824da78ad4072048db3040). Our unique Giveth Garden has been aptly named “the GIVgarden” and is deployed on Gnosis Chain. The main tools used for governance in the GIVgarden are Conviction Voting and Tao Voting.

The GIVgarden uses the [Giveth Community Covenant](/giveth-community-covenant) as a decentralized social contract that outlines standards for on-chain and off-chain behaviour.

You can visit the [**GIVgarden**](https://gardens.1hive.org/#/xdai/garden/0xb25f0ee2d26461e2b5b3d3ddafe197a0da677b98)[ here](https://gardens.1hive.org/#/xdai/garden/0xb25f0ee2d26461e2b5b3d3ddafe197a0da677b98).
...
![](/img/notion/givgarden-deprecated/givgarden-deprecated-01.png)

![](/img/notion/givgarden-deprecated/givgarden-deprecated-02.png)
...
If you feel like you have a good grasp on Giveth and [how we work](/934200f174824da78ad4072048db3040) and have something great to propose to the community, there are some processes you should respect in order to have the best possible chance of success.
...
3. **Use Advice Process.** Following your forum post the community will give you feedback and express any concerns. [The Advice Process](/advice-process) will allow you to modify your proposal or address any concerns ensuring it is the best version possible and achieves maximum consensus.

4. \*Sign the Giveth Covenant. Signing that you agree to the [Giveth Covenant](/giveth-community-covenant) in the GIVgardens will permit you to begin using the governance tools it provides.
...
| --- | --- | --- |
| Conviction Growth | 30 | days |
| Spending Limit | 2.50 | % |
| Min Conviction | 5 | % |
| Minimum Active Stake | 2 | % |
...
| Support Required | 90 | % |
| Min Approval | 10 | % |
| Vote Duration | 1.5 | days |
| Execution delay | 0.5 | days |
| Quiet Ending Period | 0.5 | days |
| Quiet Ending extension | 2 | days |
| Delegated Voting Period | 1 | days |
...
| **Parameter** | **Value** | **Metric** |
| --- | --- | --- |
| Action Deposit | 5000 | GIV |
| Challenge Deposit | 10000 | GIV |
