...
id: "givpower"
title: "GIVpower"
sidebar_label: "🔋 GIVpower"
notion_page_id: "1703ab28-d48c-81a8-9862-dbe9907f96df"
---
...
Users will also be able to “Lock” 🔒 their staked GIV in the GIVfarm to multiply their rewards APR and their GIVpower.
...
:::info ℹ️
**INFO**
GIVpower is available on Gnosis Chain, Optimism and Polygon zkEVM. If you have GIV on Mainnet and wish to earn rewards and participate with GIVpower, you can [bridge your GIV](https://bridge.gnosischain.com/). Refer to this [Linktree](https://linktr.ee/givtoken) to find all of the best places to get or bridge GIV.
...
![](/img/notion/givpower/givpower-03.png)
...
![](/img/notion/givpower/givpower-04.png)
...
![](/img/notion/givpower/givpower-05.png)
...
![](/img/notion/givpower/givpower-06.png)
...
**$$ \sqrt(1 + N) $$ **_**N = number of rounds locked**_

Let’s look at an example to understand how this works:

> Carlos decides to lock up 100 of his staked GIV for 10 rounds (20 weeks). His multiplier, rounded to 2 decimal places, is 3.32. $$ \sqrt(1 + 10) = 3.3166247903554 $$
...
> _Carlos also would get a multiplier on his GIVpower. Assuming he had 500 GIV staked and chooses to lockup 100 of that 500 he would then have 732 GIVpower._(100\*3.32) + 400 = 732
...
![](/img/notion/givpower/givpower-07.png)
...
[Video](https://drive.google.com/file/d/12afgmYukx76Lwq1mvAibteUvdCCrzGlI/view?usp=drive_link)
...
You can read more about [GIVbacks here](/givbacks).

<details>
<summary>_**See an Example GIVbacks Distribution**_</summary>
...
**Project ranking will continue to have an important role on Giveth.io and will be incorporated into future roadmap features**, such as [GIVmatching](/giveth-matching-pool)! In the future, Giveth may also incorporate other metrics or voting tools that will impact a project’s ranking.
