...
notion_page_id: "1703ab28-d48c-8108-b3c0-c4e79ab583f8"
---

Giveth.io is a platform where you can easily support the projects you love with cryptocurrency. Or create your own project and accept funding from a worldwide audience.
...
![](/img/notion/getting-started/getting-started-01.png)
...
To sign in with Gnosis you must access Giveth from your Gnosis safe. Check out the article for signing in with a [Gnosis Safe Multisig Wallet](/multisig-wallets-on-giveth) for instructions on how to sign in & more information.
...
There is more info on donating to a project in this [user guide.](/making-a-donation)

#### Create project

Our User Guide page for creating a project can be found [here.](/create-a-project)
